...
const NAUKRI_TITLE_ALLOW = [
  ...
  /\bapi\b/i,
  /\bui\s*(?:\/\s*ux)?\b/i,
  /\bqa\b|\btest(?:er|ing)?\b|\bautomation\b/i,
  /\bdevops\b|\bsre\b/i,
  /\bdata\s*(?:engineer|analyst|science)?\b/i,
  /\bjava\b/i,
  /\bflutter\b/i,
  /\bandroid\b/i,
  /\bios\b|\bswift\b/i,
  ...
  /\bspring\b/i,
  /\bkotlin\b/i,
  /\bdjango\b|\bflask\b/i,
  /\bvue\b|\bangular\b/i,
  /\bgraphql\b/i,
  /\bdocker\b|\bkubernetes\b/i,
  /\bsql\b|\bdatabase\b/i,
];

const NAUKRI_TITLE_BLOCK = [
  // Only block truly senior / management roles
  /\bsenior\b|\bsr\.?\s/i,
  ...
  /\bsales\b|\bmarketing\b|\bbusiness\s+development\b/i,
  /\bsalesforce\b|\bsap\s+/i,
  /\bblockchain\b|\bsolidity\b|\bweb3\b/i,
  /\bembedded\b|\bfirmware\b|\bhardware\b/i,
  /\bvlsi\b|\bfpga\b|\brtos\b/i,
  /\bcaptcha|verification\s*engineer/i,
];

const NAUKRI_EXP_BLOCK = [
  // Block only 3+ years to allow 0-2 yr roles
